...
INSTALL_PATH =/boot/
INSTALLSRCFILE_PATH =./release/ROS.eki
...
KIMG:
	@echo '正在生成ROS内核映像文件，请稍后……'
	$(CD) $(CPLILDR_PATH) && $(LKIMG) -lhf $(INITLDRIMH) -o ROS.eki -f $(LKIMG_INFILE)
